...
build = 
{
	...
	----------------------------------------------------
	{
		...
		DisplayPriority = 11,
		DisplayedName = "Clee-San Expedition Ship",
		Description = "<b>Description:</b> Unique expedition vessel.  \n\n<b>Strong Vs:</b> None \n\n<b>Weak Vs:</b> All \n\n<b>Prerequisites:</b> None",
	},
	{
		Type = Ship,
...
--	},
	...
	},
	{
		...
		DisplayPriority = 2,
		DisplayedName = "Advanced Engineering",
		Description = "$7013",
	},
	{
		Type = SubSystem,
		ThingToBuild = "Ksh_Sec_C_Module_WeaponsResearch",
		RequiredResearch = "",
		RequiredFleetSubSystems = "Research",
		DisplayPriority = 3,
	...
	{
		Type = SubSystem,
		ThingToBuild = "Ksh_Sec_C_Module_ArmorResearch",
		RequiredResearch = "",
		RequiredFleetSubSystems = "Research",
		DisplayPriority = 4,
	...
	{
		Type = SubSystem,
		ThingToBuild = "Smt_Ms_GravGenerator",
		RequiredResearch = "",
		RequiredFleetSubSystems = "Research",
		DisplayPriority = 5,
		DisplayedName = "Gravity Well Generator",
	...
	{
		Type = SubSystem,
		ThingToBuild = "Smt_Ms_CloakGenerator",
		RequiredResearch = "",
		RequiredFleetSubSystems = "Research",
		DisplayPriority = 6,
		DisplayedName = "$7018",
	...
	{
		Type = SubSystem,
		ThingToBuild = "Smt_Ms_FireControl",
		RequiredResearch = "",
		RequiredFleetSubSystems = "AdvancedResearch",
		DisplayPriority = 7,
		DisplayedName = "$7020",
