aitrace("LOADING TURANIC BUILD INFO")
		...
		kCollector = TUR_MINERCORVETTE
		kRefinery  = TUR_P1MOTHERSHIP
		kScout = TUR_SCOUT
		kInterceptor = TUR_FIGHTER
		kInterceptorSqd = TUR_FIGHTER5
		kBomber = TUR_FIGHTER
		kCarrier = TUR_P1MOTHERSHIP		
		kCarrierHw2 = TUR_HW2P1MOTHERSHIP
		kDestroyer = TUR_IONARRAYFRIGATE
		kDestroyerHw2 = TUR_HW2IONARRAYFRIGATE
		kBattleCruiser = TUR_P1MOTHERSHIP
		kBattleCruiserHw2 = TUR_HW2P1MOTHERSHIP
