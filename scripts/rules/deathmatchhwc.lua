...
Race_Paths = "Deathmatch,DeathmatchHWC"

Level_Pass_Tags = "dm,dm_cata,dm_hwc"
Race_Pass_Tags = "race_dm_cata,race_random_all,race_dm_hwc"
...
dofilepath("data:scripts/rules/deathmatchhwc/deathmatchhwc.lua")
