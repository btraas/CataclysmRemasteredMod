...
PlayMoviesScreen = {
	...
	------------------------------------------------------------------------------------
	{
		...
		------------------------------------------------------------------------------------
		{
			...
			;		
				-- BUTTONS
				NewMenuButton("m_btnCancel",		"$2610",	"$3602",	0,	BTN_FOOTER_STD_LAYOUT,	"FEButtonStyleCataMedBlack",	"UI_HideScreen('PlayMoviesScreen'); UI_ShowScreen('NewMainMenu', ePopup)"),	
				NewMenuButton("m_btnPlayMovie",		"$3586",	"$3587",	0,	BTN_FOOTER_YES_LAYOUT,	"FEButtonStyleCataMedBlack",	nil),
