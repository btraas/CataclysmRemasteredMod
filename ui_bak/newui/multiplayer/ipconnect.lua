...
IPConnect = {
	...
	;
	{
		...
		-- Button frame
		{
			...
			NewMenuButton("m_btnCancel",		"$2613",	"$2613",	0,	BTN_FOOTER_STD_LAYOUT,	"FEButtonStyleCataMedBlack",	[[UI_DialogCancel();]]),
			NewMenuButton("btnAccept",		"$2612",	"$2612",	0,	BTN_FOOTER_YES_LAYOUT,	"FEButtonStyleCataMedBlack",	[[UI_DialogAccept();]]),
