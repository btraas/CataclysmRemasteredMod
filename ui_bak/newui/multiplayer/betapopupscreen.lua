...
BetaPopupScreen = {
	...
	------------------------------------------------------------------------------------
	{
		...
		------------------------------------------------------------------------------------
		{
			...
			;
			-- Back Button
			NewMenuButton("m_btnCancel",				"$2610",	"",	0,	BTN_FOOTER_STD_SMALL_LAYOUT,	"FEButtonStyleCataMedBlack",			"UI_PreviousScreen(eTransition);"),
			NewMenuButton("m_btnAccept",				"$2619",	"",	0,	BTN_FOOTER_YES_LAYOUT,			"FEButtonStyleCataMedBlack",	"UI_ShowScreen('ConnectionType', eTransition);"),
