...
function ChatterMisc(shipnm,parm2,code)
	...
	if (code==CD_MissileIncoming and shiptype==Capital) then -- only if the victim is a Capital ship
		...
		if (parm2=="Hgn_TorpedoFrigate" or parm2=="Hgn_TorpedoFrigateElite" or parm2=="Hgn_Destroyer" or parm2=="Smt_destroyer" or parm2=="Smt_dreadnought") then
...
function ChatterMiscHighPriority(shipnm,parm2,code)
	...
	--	elseif (shipnm=="Smt_Worker") then
	--		playSpeechActor("shipsounds/Smt_Worker/STATUS_CAPTURE_CAPFULL_1", raceHelper(), 0, Frequency_Command )
 		else
...
attackMap["smt_acolyte"] = {"STATUS_Fighter_Under_Attack", NameCapPilot,NumCapPilots}
attackMap["smt_acolytee"] = {"STATUS_Fighter_Under_Attack", NameCapPilot,NumCapPilots}
attackMap["smt_acv"] = {"STATUS_Corvette_Under_Attack", NameSupportPilot,NumSupportPilots}
attackMap["smt_acve"] = {"STATUS_Corvette_Under_Attack",  NameCapPilot,NumCapPilots}
attackMap["smt_dreadnought"] = {"STATUS_Battlecruiser_Attack",  NameCapPilot,NumCapPilots}
attackMap["smt_destroyer"] = {"STATUS_Destroyer_Under_Attack", NameCapPilot,NumCapPilots}
attackMap["smt_carrier"] = {"STATUS_Carrier_Under_Attack", NameCapPilot,NumCapPilots}
attackMap["smt_clee_san"] = {"STATUS_Research_Under_Attack", NameCapPilot,NumCapPilots}
attackMap["smt_hivefrigate"] = {"STATUS_Frigate_Under_Attack", NameCapPilot,NumCapPilots}
attackMap["smt_mimic"] = {"STATUS_Fighter_Under_Attack", NameCapPilot,NumCapPilots}
attackMap["smt_multibeamfrigate"] = {"STATUS_Frigate_Under_Attack", NameCapPilot,NumCapPilots}
attackMap["smt_processor"] = {"STATUS_Processor_Under_Attack", NameCapPilot,NumCapPilots}
attackMap["smt_rammingfrigate"] = {"STATUS_Frigate_Under_Attack", NameCapPilot,NumCapPilots}
attackMap["smt_scaffold"] = {"STATUS_Shipyard_Under_Attack", NameCapPilot,NumCapPilots}
attackMap["smt_scout"] = {"STATUS_Fighter_Under_Attack", NameCapPilot,NumCapPilots}
attackMap["smt_sentinel"] = {"STATUS_Fighter_Under_Attack", NameCapPilot,NumCapPilots}
attackMap["smt_seraph"] = {"STATUS_Battlecruiser_Under_Attack", NameCapPilot,NumCapPilots}
attackMap["smt_superacolyte"] = {"STATUS_Fighter_Under_Attack", NameCapPilot,NumCapPilots}
attackMap["smt_Worker"] = {"STATUS_Worker_Under_Attack", NameCapPilot,NumCapPilots}
...
attackMapKuun = {}
attackMapKuun["Smt_destroyer"] = "STATUS_Destoyer_Under_Attack_1"
attackMapKuun["Smt_Carrier"] = "STATUS_Carrier_Under_Attack_1"
attackMapKuun["smt_carrier"] = "STATUS_Carrier_Under_Attack_1"
attackMapKuun["Smt_dreadnought"] = "STATUS_Battlecruiser_Under_Attack_1"
attackMapKuun["Smt_ms"] = "STATUS_Mothership_Under_Attack_1"
attackMapKuun["smt_ms"] = "STATUS_Mothership_Under_Attack_1"
attackMapKuun["smt_ms_sp"] = "STATUS_Mothership_Under_Attack_1"
attackMapKuun["Smt_Seraph"] = "STATUS_Battlecruiser_Under_Attack_1"
attackMapKuun["Smt_hivefrigate"] = "STATUS_frigate_under_attack_1"
attackMapKuun["Smt_RammingFrigate"] = "STATUS_frigate_under_attack_1"
attackMapKuun["Smt_multibeamfrigate"] = "STATUS_frigate_under_attack_1"
attackMapKuun["Smt_ACV"] = "STATUS_corvette_under_attack_1"
attackMapKuun["Smt_ACVE"] = "STATUS_corvette_under_attack_1"
attackMapKuun["Smt_Mimic"] = "STATUS_fighter_under_attack_1"
attackMapKuun["Smt_SuperAcolyte"] = "STATUS_fighter_under_attack_1"
attackMapKuun["Smt_AcolyteE"] = "STATUS_fighter_under_attack_1"
attackMapKuun["Smt_Acolyte"] = "STATUS_fighter_under_attack_1"
attackMapKuun["Smt_scout"] = "STATUS_fighter_under_attack_1"
attackMapKuun["Smt_SuperAcolyte"] = "STATUS_fighter_under_attack_1"
attackMapKuun["Smt_Processor"] = "STATUS_processor_under_attack_1"
attackMapKuun["Smt_Worker"] = "STATUS_Worker_under_attack_1"
attackMapKuun["smt_worker"] = "STATUS_Worker_under_attack_1"
attackMapKuun["Smt_Clee_San"] = "STATUS_research_under_attack_1"
attackMapKuun["Smt_SuperAcolyte"] = "STATUS_fighter_under_attack_1"
...
-- Need SMT otherwise we don't know what race?
statusFiles["SMT_STRIKE"] = {} -- STRIKE GROUPS
statusFiles["SMT_STRIKE"]["folder"] = "shipsounds/strike/"
statusFiles["SMT_STRIKE"]["STATUS_UNDERATTACK"] = 0
-- CR CSF -- statusFiles["shared"]["STATUS_INMINEFIELD"] = 1
