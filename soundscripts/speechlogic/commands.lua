...
-- CR CSF -- shipFiles["shared"]["COMMAND_WAYPOINT"] = 1					-- 								-- Working 
-- CR CSF -- shipFiles["shared"]["COMMAND_MOVETOSOB"] = 1				-- Move to specific group 		-- not tested
-- CR CSF -- shipFiles["shared"]["COMMAND_CANCELLED"] = 1	--nw		-- 								-- Not working
-- CR CSF -- shipFiles["shared"]["COMMAND_ATTACK_CANCELLED"] = 1			-- 								-- Working
shipFiles["shared"]["COMMAND_MOVE_CANCELLED"] = 1			-- 								-- Working
-- CR CSF -- shipFiles["shared"]["COMMAND_RESOURCESALVAGE"] = 1			-- Debris/container				-- working
-- CR CSF -- shipFiles["shared"]["COMMAND_RESOURCECOLLECTORHARVEST"] = 1	-- Asteroid harvest				-- working
-- CR CSF -- shipFiles["shared"]["COMMAND_CAPTURE"] = 1					-- Marine/infiltrate/worker 	-- working
shipFiles["shared"]["COMMAND_ATTACK"] = 4					-- 								-- Working
-- CR CSF -- shipFiles["shared"]["COMMAND_HS"] = 1						-- Entering hyperspace 			-- working
-- CR CSF -- shipFiles["shared"]["COMMAND_HS_INHIBITOR_DETECTED"] = 1 	-- interrupted by inhibitor 	-- not tested
-- CR CSF -- shipFiles["shared"]["COMMAND_HS_INTERRUPTED"] = 1 			-- Interrupted					-- not tested
-- CR CSF -- shipFiles["shared"]["COMMAND_HS_GATE"] = 1 					-- entering HS gate				-- not tested
-- CR CSF -- shipFiles["shared"]["COMMAND_HS_INSUFFICIENT"] = 1 			-- Not enough cash				-- not tested
-- CR CSF -- shipFiles["shared"]["COMMAND_COMBATMAN"] = 1				-- Not sure what this is		-- working
shipFiles["shared"]["COMMAND_MOVEATTACK"] = 1				--								-- working
-- CR CSF -- shipFiles["shared"]["COMMAND_LAUNCH"] = 1					-- Per launching ship			-- working
-- CR CSF -- shipFiles["shared"]["COMMAND_GUARD"] = 1
shipFiles["shared"]["COMMAND_DOCK"] = 3
--shipFiles["shared"]["COMMAND_PARADE"] = 1					
-- CR CSF -- shipFiles["shared"]["COMMAND_RETIRE"] = 1		
shipFiles["shared"]["COMMAND_AGGRESSIVE"] = 2		
-- CR CSF -- shipFiles["shared"]["COMMAND_DEFENSIVE"] = 1
shipFiles["shared"]["COMMAND_PASSIVE"] = 3
-- CR CSF -- shipFiles["shared"]["COMMAND_RANGESHORT"] = 1				-- Don't know what these are  	-- not tested
-- CR CSF -- shipFiles["shared"]["COMMAND_RANGEMED"] = 1					--								-- not tested
-- CR CSF -- shipFiles["shared"]["COMMAND_RANGELONG"] = 1				--								-- not tested
-- CR CSF -- shipFiles["shared"]["COMMAND_RANGEFORCE"] = 1				--								-- not tested
-- CR CSF -- shipFiles["shared"]["COMMAND_REPAIR"] = 1					--								-- not working
shipFiles["shared"]["COMMAND_SELECTED"] = 2					--								-- working

--NEW: Apr 18,2015
-- CR CSF -- shipFiles["shared"]["COMMAND_BUILD"] = 1					-- by parent ship				-- working
-- CR CSF -- shipFiles["shared"]["COMMAND_BUILD_PAUSED"] = 1												-- not tested
-- CR CSF -- shipFiles["shared"]["COMMAND_FOLLOWING"] = 1												-- not tested
-- CR CSF -- shipFiles["shared"]["COMMAND_STRIKEGROUP_FORM_RESPONSE"] = 1								-- not tested
-- CR CSF -- shipFiles["shared"]["COMMAND_STRIKEGROUP_FORMATIONSET"] = 1									-- not tested
-- CR CSF -- shipFiles["shared"]["COMMAND_STRIKEGROUP_DISBAND"] = 1										-- not tested
-- CR CSF -- shipFiles["shared"]["COMMAND_DEFENSEFIELDON"] = 1											-- not tested
-- CR CSF -- shipFiles["shared"]["COMMAND_DEFENSEFIELDOFF"] = 1											-- not tested
-- CR CSF -- shipFiles["shared"]["COMMAND_DEFENCEFIELDOUTOFPOWER"] = 1									-- not tested
-- CR CSF -- shipFiles["shared"]["COMMAND_HS_EXIT"] = 1													-- not working
-- CR CSF -- shipFiles["shared"]["COMMAND_HS_GATEFORMED"] = 1											-- not tested
-- CR CSF -- shipFiles["shared"]["COMMAND_ATTACK_FRIENDLY"] = 1			-- not tested
...
-- These are ignored if 'sameas' (above) isn't blank
shipFiles["bshared"]["COMMAND_MOVE"] = 3
...
-- CR CSF -- shipFiles["bshared"]["COMMAND_MOVEATTACK"] = 1				--								-- working
...
-- CR CSF -- shipFiles["Bst_scout"]["COMMAND_WAYPOINT"] = 1
-- CR CSF -- shipFiles["Bst_scout"]["COMMAND_MOVETOSOB"] = 1
-- CR CSF -- shipFiles["Bst_scout"]["COMMAND_MOVEATTACK"] = 1
...
-- CR CSF -- shipFiles["Bst_acolyte"]["COMMAND_MOVE_CANCELLED"] = 1
