...
function CpuBuild_PersonalityDemand_Somtaaw()
...
function DetermineDemandWithNoCounterInfo_Somtaaw()
...
function DetermineSpecialDemand_Somtaaw()
		if (ShipDemandGet( kInterceptor ) > 0 and IsResearchDone(SMTFIGHTERDRIVE) == 1 and NumSquadrons(kInterceptor) < 3 and s_militaryPop < 10) then
...
Proc_CpuBuild_PersonalityDemand = CpuBuild_PersonalityDemand_Somtaaw
Proc_DetermineBuilderClassDemand = DetermineBuilderClassDemand_Somtaaw
Proc_DetermineDemandWithNoCounterInfo = DetermineDemandWithNoCounterInfo_Somtaaw
Proc_DetermineSpecialDemand = DetermineSpecialDemand_Somtaaw
