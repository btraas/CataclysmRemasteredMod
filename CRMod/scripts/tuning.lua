...
ShipController = {
	...
	zRotationAccelerationMultiplier 		= 1,				-- the Z rotation acceleration is higher than the other accelerations in ships. We don't want an extra shiptuning variable for this. All ships have a higher z rotation acceleration
	flightManeuverRotationBoost			= 1,				-- in flightmaneuvers the ships get a higher rotation agility. The maximum rotation is not changed, instead, the way they steer is 'snappier'..
...
Ship = {
	battleTimeOutTime			= 2.8,				-- Don't tweak this if you don't know what you are doing. takes 10 seconds to say that you're not in a battle anymore, while you are in battle you can't be cloaked, you are also visible always to the player you are firing at
...
CombatInfo = {
    ...
    numberOfBlockedShotsBeforeMove      = 1,
...
MultiplierCap = {
    ...
    CloakDetection = 4.0,
    VisualRange = 8.0,
    PrimarySensorsRange = 3.0,
    SecondarySensorsRange = 3.0,
