...
--     NUM_TACTICS_TYPES                     };
-- } TacticsType;
function KASShipTacticsGet(sobGroupName)

    HW2Tactics = SobGroup_GetTactics(sobGroupName)

    if (HW2Tactics == 0) then
        return 2
    elseif (HW2Tactics == 1) then
        return 0
    elseif (HW2Tactics == 2) then
        return 1
    end
end
...
function KAS_KillerAsteroidsMove()
    ...
    attrVELOCITY_TOWARDS = 45 * 0.35 --125
...
function KAS_ShipsSetRetaliation(team, bRetaliate)
    ...
    if (bRetaliate ~= 0) then
        SobGroup_SetTactics(team, 0)    --PassiveTactics
    else
        SobGroup_SetTactics(team, 2)    --AggressiveTactice
    end
end
