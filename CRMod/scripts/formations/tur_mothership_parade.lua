...
paradeSlot("Tur_Scout",			{-805, -525, 2100},	{0,0,1},	{-1,0,0},	70);
...
paradeSlot("Tur_MinerCorvette",		{-805, -525, 180},	{0,0,1},	{-1,0,0},	105);

paradeSlot("Tur_IonArrayFrigate", 	{-805, -525, 0},	{0,0,1},	{-1,0,0},	280);
paradeSlot("Tur_Hw2IonArrayFrigate", 	{-805, -525, 0},	{0,0,1},	{-1,0,0},	280);
