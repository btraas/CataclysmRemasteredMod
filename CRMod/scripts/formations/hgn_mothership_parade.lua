...
paradeSlot("Hgn_HeavyAssaultCorvette",	{-1239, -100, 716},    	{0,0,1}, {-1,0,0},      0 );
...
paradeSlot("Hgn_PulsarFighter",		{-677, -100, 1025},	{0,0,1}, {-1,0,0},      0);
...
paradeSlot("Hgn_PulsarTurret",		{-535, 0, 296},     	{0,0,1}, {0,1,0},      0);
paradeSlot("Hgn_IonTurret",		{-706, 0, 292},    	{0,0,1}, {0,1,0},      0);
