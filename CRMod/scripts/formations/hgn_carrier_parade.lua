...
paradeSlot("Hgn_HeavyAssaultCorvette",	{-1045, -102, 875},    	{0,0,1}, {-1,0,0},       0 );
...
paradeSlot("Hgn_PulsarFighter",		{-447, -102, 1097},    	{0,0,1}, {-1,0,0},      0);
...
paradeSlot("Hgn_PulsarTurret",		{130, 0, 704},     	{0,0,1}, {0,1,0},      0);
