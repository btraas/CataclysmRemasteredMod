...
UserProfile = {
	...
	------------------------------------------------------------------------------------
	{
		...
		sizetype = "contain",
			...
			;		
				-- BUTTONS
				NewMenuButton("m_btnCancel",		"$2613",	"$3515",	0,	BTN_FOOTER_STD_LAYOUT,	"FEButtonStyleCataMedBlack",	nil,0),	
				NewMenuButton("m_btnCreateNew",		"$3510",	"$3509",	0,	BTN_FOOTER_STD_LAYOUT,	"FEButtonStyleCataMedBlack",	nil),
				NewMenuButton("m_btnPlayerSetup",	"$3512",	"$3511",	0,	BTN_FOOTER_STD_LAYOUT,	"FEButtonStyleCataMedBlack",	nil),
				NewMenuButton("m_btnDelete",		"$3514",	"$3513",	0,	BTN_FOOTER_STD_LAYOUT,	"FEButtonStyleCataMedBlack",	nil),
				NewMenuButton("m_btnAccept",		"$2619",	"$3517",	0,	BTN_FOOTER_YES_LAYOUT,	"FEButtonStyleCataMedBlack",	nil),
