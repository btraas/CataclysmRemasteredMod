...
----------------------- Title Text Row -----------------------			
		{
			...
			
			{
				...
				;
				{
					...
					;
					NewMenuButton("m_btnAccept",	"$5172",	"",	0,	BTN_FOOTER_SMALL_LAYOUT,	"FEButtonStyleCataMedBlack",	 [[UI_DialogAccept();]]),
					NewMenuButton("m_btnCancel",	"$5171",	"",	0,	BTN_FOOTER_SMALL_LAYOUT,	"FEButtonStyleCataMedBlack",	[[UI_DialogCancel();]]),
