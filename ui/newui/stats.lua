...
Stats = {
	...
	arrangeweight=1,
		...
		------------------------------------------------------------------------------------
		{
			...
			;		
				-- BUTTONS
				NewMenuButton("btnMainMenu",		"$2617",	"$4565",	0,	BTN_FOOTER_STD_LAYOUT,	"FEButtonStyleCataMedBlack",	"UI_ShowScreen(\"NewMainMenu\", eTransition)"),	
			
				NewMenuButton("btnReplay",			"$5179",	"$4563",	0,	BTN_FOOTER_STD_LAYOUT,	"FEButtonStyleCataMedBlack",	nil,0),	
				NewMenuButton("btnSaveRecorded",	"$5180",	"$4564",	0,	BTN_FOOTER_STD_LAYOUT,	"FEButtonStyleCataMedBlack",	nil,0),	
				NewMenuButton("btnNewGame",			"$5181",	"$4566",	0,	BTN_FOOTER_STD_LAYOUT,	"FEButtonStyleCataMedBlack",	nil,0),	
						
				-- Actually the continue button.  Not Back...
				NewMenuButton("btnBack",			"$5188",	"$4562",	0,	BTN_FOOTER_YES_LAYOUT,	"FEButtonStyleCataMedBlack",	nil),	
