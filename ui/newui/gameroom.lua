	...
	------------------------------------------------------------------------------------
	{
		...
		------------------------------------------------------------------------------------
		{
			...
			----------- Options Bar ---------------------
			{
				...
				--NewMenuButton("txtBtnREFRESH",  "$3421",    "$3631",    0,  BTN_MENU_SMALL_FILL_LAYOUT, "FEButtonStyleCatMedBlack",    nil),
				NewMenuButton("txtBtnFILTERS",	"$3401",	"$3633",	0,	BTN_MENU_SMALL_FILL_LAYOUT,	"FEButtonStyleCataMedBlack",	nil),
				NewMenuButton("txtBtnJOINGAME",	"$3417",	"$3630",	0,	BTN_MENU_SMALL_FILL_LAYOUT,	"FEButtonStyleCataMedBlack",	nil),		
				...
				--Refresh Checkbox
                {
					...
					textColor                   = COLOR_YELLOW_SOLID,
        			overTextColor               = COLOR_YELLOW_SOLID, 
        			pressedTextColor            = COLOR_YELLOW_SOLID,
 			       	disabledTextColor           = COLOR_GRAY_SOLID,
		...
		------------------------------------------------------------------------------------
		{
			...
			;
			-- BUTTONS	
			NewMenuButton("m_btnBack",			"$3433",	"$3629",	0,	BTN_FOOTER_FORCELEFT_LAYOUT,	"FEButtonStyleCataMedBlack",	nil),			
			NewMenuButton("txtBtnHOSTGAME",		"$3418",	"$3634",	0,	BTN_FOOTER_YES_LAYOUT,	"FEButtonStyleCataMedBlack",	nil),
