...
CustomFX = {
	...
	
	{
		...
		------------------------------------------------------------------------------------
		{
			...
			-- BUTTONS			
			NewMenuButton("m_btnCancel",				"$5156",	"$5277",	0,	BTN_FOOTER_STD_LAYOUT,	"FEButtonStyleCataMedBlack",	nil),
			--NewMenuButton("m_btnRestoreDefaultOptions",	"$5142",	"$5275",	0,	BTN_FOOTER_STD_LAYOUT,	"FEButtonStyle1_Outlined",	nil),
			NewMenuButton("m_btnAccept",				"$5157",	"$5278",	0,	BTN_FOOTER_YES_LAYOUT,	"FEButtonStyleCataMedBlack",	nil),
