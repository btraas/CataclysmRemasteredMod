...
FEListBoxItemButtonStyle = 
	...
	FEButtonStyleSmall = 
	{
		...
		BackgroundGraphic = MENU_BUTTON_GRAPHIC_SMALL,
	...
	FEButtonStyleC = 
	{
		...
		BackgroundGraphic = {
			size = {206, 30},
			texture = "DATA:UI\\NewUI\\Styles\\cataclysm_button.tga",
		...
		OverGraphic = {
			size = {206, 30},
			texture = "data:ui/newui/styles/cataclysm_button_hover.tga",
