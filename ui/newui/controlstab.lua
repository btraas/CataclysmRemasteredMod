...
local LocalControlsTab = {
...

	{
		...
		-- BUTTONS			
		NewMenuButton("m_btnRestoreDefaults",	"$5097",	"$5099",	0,	BTN_FOOTER_MED_LAYOUT,	"FEButtonStyleCataMedBlack",	nil),
		NewMenuButton("m_btnReset",				"$5182",	"$5098",	0,	BTN_FOOTER_MED_LAYOUT,	"FEButtonStyleCataMedBlack",	nil),
