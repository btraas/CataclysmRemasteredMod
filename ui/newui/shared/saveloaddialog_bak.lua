...
SaveLoadDialog = {
	...
	------------------------------------------------------------------------------------
	{
		...
		------------------------------------------------------------------------------------
		{
			...
			;
			NewMenuButton("m_btnCancel",		"$2613",	"$2613",	0,	BTN_FOOTER_STD_LAYOUT,	"FEButtonStyleCataMedBlack",	nil),		
			NewMenuButton("m_btnDelete",		"$3572",	"$3573",	0,	BTN_FOOTER_STD_LAYOUT,	"FEButtonStyleCataMedBlack",	nil),		

			NewMenuButton("m_btnLoadSkirmish",		"$3574",	"$3575",	0,	BTN_FOOTER_YES_LAYOUT,	"FEButtonStyleCataMedBlack",	nil),		
			NewMenuButton("m_btnLoadCampaign",		"$3576",	"$3577",	0,	BTN_FOOTER_YES_LAYOUT,	"FEButtonStyleCataMedBlack",	nil),		
			NewMenuButton("m_btnLoadRecorded",		"$3578",	"$3579",	0,	BTN_FOOTER_YES_LAYOUT,	"FEButtonStyleCataMedBlack",	nil),		

			NewMenuButton("m_btnSaveSkirmish",		"$3580",	"$3581",	0,	BTN_FOOTER_YES_LAYOUT,	"FEButtonStyleCataMedBlack",	nil),		
			NewMenuButton("m_btnSaveCampaign",		"$3582",	"$3583",	0,	BTN_FOOTER_YES_LAYOUT,	"FEButtonStyleCataMedBlack",	nil),		
			NewMenuButton("m_btnSaveRecorded",		"$3584",	"$3585",	0,	BTN_FOOTER_YES_LAYOUT,	"FEButtonStyleCataMedBlack",	nil),		
