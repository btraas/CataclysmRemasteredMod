	...
	------------------------------------------------------------------------------------
	{
			...
			------------------------------------------
			{
				...
				-------------------------------------------------
				{
...

					{
						...
						;
						NewMenuButton("txtBtnOPTIONPRESETS",	"$5131",	"$3469",	0,	LAYOUT_PRESET_BUTTON,	"FEButtonStyleCataLargeBlack",	nil),	
					},
		...
		------------------------------------------------------------------------------------
		{
			...
			;		
				...
				NewMenuButton("txtBtnSTARTGAME",	"$3363",	"$3337",	0,	BTN_FOOTER_YES_LAYOUT,	"FEButtonStyleCataMedBlack",	nil),	
