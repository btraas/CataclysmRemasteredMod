...
GameInfoScreen = {
		...
		
	{
		...
		-- Button frame
		{
			...
			NewMenuButton("m_btnBack",		"$3420",	"",			0,	BTN_FOOTER_STD_LAYOUT,	"FEButtonStyleCataMedBlack",	nil),
			NewMenuButton("m_btnJoin",		"$3417",	"$3630",	0,	BTN_FOOTER_YES_LAYOUT,	"FEButtonStyleCataMedBlack",	nil),
		},
