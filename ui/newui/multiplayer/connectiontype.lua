...
ConnectionType = {
	...
	------------------------------------------------------------------------------------
	{
		...
		------------------------------------------------------------------------------------
		{
			...
			;
			-- Back Button
			NewMenuButton("m_btnCancel",	"$3539",	"$3043",	0,	BTN_FOOTER_STD_SMALL_LAYOUT,	"FEButtonStyleCataMedBlack",	"UI_PreviousScreen(eTransition);"),
...
-- hackhack
BetaPopupScreen = ConnectionType;
