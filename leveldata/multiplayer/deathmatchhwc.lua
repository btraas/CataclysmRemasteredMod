...
Directories =
{
  Levels = "data:LevelData\\Multiplayer\\DeathMatchHWC\\",
  ProfileLevels = "profiles:Levels\\DeathmatchHWC\\",
  BuildAndResearch = "data:LevelData\\Multiplayer\\DeathMatchHWC\\BuildAndResearch\\",
}
