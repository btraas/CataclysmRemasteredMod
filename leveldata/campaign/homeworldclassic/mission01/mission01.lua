...
function Init_Mission01_FleetIntel_FIFormationTrialLBXIn(TeamName)
    ...
    SobGroup_SetTactics("NIS_SobGroup", PassiveTactics)
	return
...
function Init_Mission01(MissionName)
	...
	KAS_GrantResearchOption(0, "Hyperspace")
...
function Watch_Mission01(MissionName)
	...
	if (G_PlayerHasUsedFormation == 0) then 
        ...
        KAS_FillShipsByClass_Normal("GrowSelection_FormTrialTDUnderAttackFighters", "GrowSelection_FormTrialTDUnderAttack", "Fighter")
	...
	if (((KASShipTacticsGet("GrowSelection_TacticsTrialTDUnderAttack") == 0) or (KASShipTacticsGet("GrowSelection_TacticsTrialTDUnderAttack") == 2)) and (G_BeginScoutTrialTactics == 1)) then     --kasfTutShipsTactics(kasGrowSelectionPtr("TacticsTrialTDUnderAttack"))    --kasfTutShipsTactics(kasGrowSelectionPtr("TacticsTrialTDUnderAttack"))
	...
	if (_VIFONCE041 == 0 and (KAS_PlayerHasResearch(0, "FighterChassis") ~= 0)) then  -- "ifonce" #41    --kasfDoesPlayerHave("Chassis1")
